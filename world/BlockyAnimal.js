// BlockyAnimal class - simplified version with lighting support
class BlockyAnimal {
    constructor() {
    ...
    render() {
        ...
        // Main body - using Dome with transparency
        var body = new Dome();
        ...
        // Outer halo - slightly larger dome
        var outer = new Dome();
        ...
        for (let i = 0; i < tentacleCount; i++) {
            ...
            for (let j = 0; j < tentacleLength; j++) {
                ...
                // Update currentMatrix for next segment
